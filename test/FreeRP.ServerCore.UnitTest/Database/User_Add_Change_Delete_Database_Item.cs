...
{
    [TestClass]
    public class User_Add_Change_Delete_Database_Item
    {
        ...
        public async Task Init()
        {
            FrpDatabase db = new()
            {
                DatabaseId = "UserAddChangeDeleteDatabaseItem",
                AccessMode = FrpAccessMode.AccessModeUser,
                AllowUnknownData = true
            };

            //Add user
            FrpUser user = new() { Email = "UserAddChangeDeleteDatabaseItem@test.org", Password = "TestPass123!" };
